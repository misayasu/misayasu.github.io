...
Whatever the approaches we use, field sampling is like drawing an original painting. We can draw hundreds of different portraits from one subject (research question). We talk a lot about analysis methods, graphics, findings, and so on, but I wish there were more discussions about ‘How to sample?' because with GIS and machine learning, new approaches to sampling designs are possible now. Those new approaches will bring us new insights. This could be a new and exciting era of field sampling.
