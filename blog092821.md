...
Deciding where to sample is the most important step in field data collection, as this affects the subsequent data analysis. We talk a lot about analysis methods, graphics, findings, and so on, but how much do we talk about ‘How to sample?'<br/>
