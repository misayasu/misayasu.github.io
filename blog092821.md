...
Deciding where to sample is the most important step in field research, as the decision affects the subsequent data analysis. We talk a lot about analytical methods, graphics, findings, and so on, but how much do we talk about ‘How to sample?'<br/>
